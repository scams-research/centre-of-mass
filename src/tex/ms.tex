...
%%% Potential Journals To Keep in Mind
%% These all accept Letter style papers
...
\label{sec:intro}Th% e calculation of the centre of mass of a group of particles, such as in a molecule, is important across computational chemistry and physics~\\citehang_chemically_2024,happel_coordinated_2024,maggi_universality_2021,grillo_molecular_2023,bullerjahn_unwrapping_2023,jaeger-honz_systematic_2024}.
...
%
\begin{figure*}
  \includegraphics[width=\textwidth]{figures/full_banner2.pdf}
  \caption{
...
\begin{figure}
    \centering
    \includegraphics[width=8cm]{figures/degenerate_graph.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=8cm]{figures/Asymmetry.pdf}
