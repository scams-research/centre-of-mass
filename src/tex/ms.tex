...
The \emph{pseudo}-centre of mass recentering method is approximately twice as fast as the \textsc{geomstats} implementation of the intrinsic method, due to reduced complexity and number of steps. 
%
\begin{figure}
    \centering
